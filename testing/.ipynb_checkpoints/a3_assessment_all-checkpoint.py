# This is the code from Q-Bench/example_code_for_idefics/a3_assessment_all.py
# q bench用结果/100做logits
# CLIP—IQA是直接用logits_per_image做logits，*2.6593
# Open CLIP是100* image_features @ class_embeddings做logits
# 其实我们应该用q align的方式，问题是logits是怎么处理一下
